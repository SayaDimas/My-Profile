...
export default function Portfolio() {
  ...
  const projects: Project[] = [
    {
      id: 1,
      title: 'SIMP (Sistem Informasi Manajemen Proyek)',
      description: 'Platfoam dengan fitur manajemen proyek lengkap, termasuk task tracking, timeline, dan kolaborasi tim untuk efisiensi kerja.',
      technologies: ['React', 'Node.js', 'mysql', 'API'],
      image: '✓',
      link: '',
      github: '',
      category: 'Website',
